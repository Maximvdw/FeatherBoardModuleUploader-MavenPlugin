...
import be.maximvdw.featherboard.api.FBModule;
import be.maximvdw.featherboard.api.annotations.*;
    ...
    public void execute() throws MojoExecutionException {
        ...
        try {
            ...
            while (e.hasMoreElements()) {
                ...
                if (FBModule.class.isAssignableFrom(c)) {
                    Class<? extends FBModule> componentClass = c.asSubclass(FBModule.class);
